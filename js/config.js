...
window.PRODUCTS_DB = [
    ...
    { id: 8, name: "Hub USB-C Multipuerto", price: "950", image: "images/8-hub-usb.jpg", description: "Expande tus conexiones con HDMI, USB-A, Ethernet y Lector SD.", fullDescription: "La navaja suiza de la conectividad. Un solo cable te da acceso a pantallas externas 4K, red gigabit y carga passthrough de 100W." },
    { id: 9, name: "Base de Carga Inalámbrica", price: "850", image: "images/9-carga.jpg", description: "Carga rápida Qi simultánea para teléfono, reloj y auriculares.", fullDescription: "Mantén tu escritorio sin cables. Soporta carga rápida de 15W y tiene un diseño neomórfico que combina con cualquier entorno." },
    ...
    { id: 13, name: "Soporte Ajustable Aluminio", price: "799", image: "images/13-soporte.jpg", description: "Eleva tu laptop a la altura de tus ojos para mejor postura.", fullDescription: "Soporte plegable y ultraligero. Mejora la ventilación del equipo y previene dolores de cuello al elevar la pantalla al nivel óptimo." },
    { id: 14, name: "Webcam 4K Studio Pro", price: "2,850", image: "images/14-webcam.jpg", description: "Cámara de alta resolución con anillo de luz para videollamadas.", fullDescription: "Hazte notar en tus reuniones virtuales. Sensor 4K real, corrección automática de luz y micrófonos estéreo duales con reducción de ruido." },
    ...
    { id: 18, name: "Disco Externo 2TB SSD", price: "3,890", image: "images/18-disco-ssd.jpg", description: "Almacenamiento ultra-rápido y resistente contra caídas.", fullDescription: "Transferencias a velocidad de la luz (hasta 1050 MB/s). Su diseño recubierto de goma lo hace resistente al agua, polvo y caídas extremas." },
